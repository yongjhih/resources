...
ZombiePedSkins = {13,22,56,68,69,70,92,97,105,107,108,127,128,152,162,167,188,206,209,212,229,230,258,264,277,280,287 } --ALTERNATE SKIN LISTS FOR ZOMBIES (SHORTER LIST IS TEXTURED ZOMBIES ONLY)
		...
		if (table.getn( allzombies )+pacecount < newZombieLimit ) and (ZombieStreaming == 1) then	
			...
			if (table.getn( liveplayers ) > 0 ) then
				...
				for PKey,thePlayer in ipairs(liveplayers) do
					if (getElementData (thePlayer, "dangercount")) then
